...
public class RedmineLinkAnnotatorTest extends TestCase {
    ...
    public void testWikiLinkSyntax() {
        ...
        assertAnnotatedTextEquals("fixes 10,11,12", "<a href='" + REDMINE_URL + "issues/show/10'>fixes 10</a>,<a href='" + REDMINE_URL + "issues/show/11'>11</a>,<a href='" + REDMINE_URL + "issues/show/12'>12</a>");
        assertAnnotatedTextEquals("references 110,111,112,113", "<a href='" + REDMINE_URL + "issues/show/110'>references 110</a>,<a href='" + REDMINE_URL + "issues/show/111'>111</a>,<a href='" + REDMINE_URL + "issues/show/112'>112</a>,<a href='" + REDMINE_URL + "issues/show/113'>113</a>");
        assertAnnotatedTextEquals("closes 210, 211", "<a href='" + REDMINE_URL + "issues/show/210'>closes 210</a>,<a href='" + REDMINE_URL + "issues/show/211'> 211</a>");
        assertAnnotatedTextEquals("refs 310, 11, 4, 4120", "<a href='" + REDMINE_URL + "issues/show/310'>refs 310</a>,<a href='" + REDMINE_URL + "issues/show/11'> 11</a>,<a href='" + REDMINE_URL + "issues/show/4'> 4</a>,<a href='" + REDMINE_URL + "issues/show/4120'> 4120</a>");
    }
